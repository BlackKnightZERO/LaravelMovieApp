        ...
        <div class="container mx-auto flex flex-col md:flex-row  items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                <div class="relative">
                    ...
                    <span class="flex items-center absolute left-0 top-0 ml-2 mt-2"><img src="/img/search.svg" alt="" srcset="" class="w-4 h-4 left-0 top-0"></span>
                </div>
                <!-- <img src="/img/search.svg" alt="" srcset="" class="w-4 h-4 left-0 top-0"> -->
                <div class="mt-3 md:mt-2 ml-3">
                    <a href="#">
                        <img src="/img/afaysal.jpg" alt="avatar" class="rounded-full w-8 h-8">
                    </a>
                </div>
            </div>
        </div>
